...
//Testobjekte für Preview
val u = User(0,"Köln", listOf(Genre.Abstract,Genre.Strategy,Genre.Thematic,Genre.Wargame),30,2, listOf(), listOf())
val ga = Game(0,listOf(Genre.Abstract,Genre.Strategy,Genre.Thematic,Genre.Wargame),3,3,1000)
val gr = Group(0,"Köln", listOf(Genre.Abstract,Genre.Strategy,Genre.Thematic,Genre.Wargame),25,3)
...
val userList = listOf<User>(
    ...
    User(3,"Köln", listOf(Genre.Family),54,4, listOf(), listOf(1,15,24,30)),
    ...
    User(5,"Köln", listOf(Genre.Thematic),50,3, listOf(), listOf(7,11,27,39,42,48)),
    User(6,"Köln", listOf(Genre.Children,Genre.Family),24,1, listOf(), listOf(3,19,26,41)),
    User(7,"Hamburg", listOf(Genre.Family),34,2, listOf(), listOf(49,26)),
    ...
    User(12,"Hamburg", listOf(Genre.Strategy,Genre.Wargame),40,5, listOf(), listOf(11,2,18,20,29,38,47)),
    User(13,"Hamburg", listOf(Genre.Family,Genre.Strategy),37,1, listOf(), listOf(49,26,18)),
    User(14,"Hamburg", listOf(Genre.Children),48,2, listOf(), listOf(3)),
    User(15,"Hamburg", listOf(Genre.Party),24,3, listOf(), listOf(19,26,30)),
    User(16,"München", listOf(Genre.Thematic),29,2, listOf(), listOf(27,18,39)),
    User(17,"München", listOf(Genre.Abstract,Genre.Customizable,Genre.Strategy),20,5, listOf(), listOf(24,29,31,33,42,43,48)),
    User(18,"München", listOf(Genre.Thematic),45,3, listOf(), listOf(7,18,27,42,49,11)),
    User(19,"München", listOf(Genre.Customizable,Genre.Strategy),61,3, listOf(), listOf(18,6,14,29)),
    User(20,"München", listOf(Genre.Abstract),36,3, listOf(), listOf(50,9,10,28)),
    ...
    User(23,"Berlin", listOf(Genre.Party),27,2, listOf(), listOf(14,5)),
    User(24,"Berlin", listOf(Genre.Strategy),22,3, listOf(), listOf(8,29,37,48)),
    ...
    User(27,"Berlin", listOf(Genre.Customizable),40,5, listOf(), listOf(1,14,29,44)),
    User(28,"Berlin", listOf(Genre.Wargame),23,5, listOf(), listOf(31,29,48,37,33,13)),
    User(29,"Berlin", listOf(Genre.Abstract,Genre.Party),19,5, listOf(), listOf(9,5,17,23,28,36)),
    User(30,"Berlin", listOf(Genre.Strategy),23,3, listOf(), listOf(48,22,20,2)),
    User(31,"Berlin", listOf(Genre.Wargame),36,3, listOf(), listOf(37,43)),
    User(32,"Berlin", listOf(Genre.Abstract),38,1, listOf(), listOf(50)),
    User(33,"Frankfurt am Main", listOf(Genre.Thematic),25,3, listOf(), listOf(27,11,8,29)),
    ...
    User(38,"Düsseldorf", listOf(Genre.Children),25,2, listOf(), listOf(16)),
    User(39,"Düsseldorf", listOf(Genre.Abstract,Genre.Strategy,Genre.Thematic),24,4, listOf(), listOf(36,44,43,48,8,18,27)),
    User(40,"Düsseldorf", listOf(Genre.Strategy),34,5, listOf(), listOf(11,27,29,37,48)),
    ...
    User(43,"Stuttgart", listOf(Genre.Party),53,2, listOf(), listOf(19,34,30)),
    User(44,"Bonn", listOf(Genre.Abstract,Genre.Children,Genre.Strategy),27,4, listOf(), listOf(50,1,4,28,24,17)),
    User(45,"Bonn", listOf(Genre.Family),37,1, listOf(), listOf(49,26,21)),
    User(46,"Essen", listOf(Genre.Thematic),26,5, listOf(), listOf(35,23,8,44,50)),
    User(47,"Essen", listOf(Genre.Customizable),35,1, listOf(), listOf(29,31,25,1)),
