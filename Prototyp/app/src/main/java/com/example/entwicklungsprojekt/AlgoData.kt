...
fun getUserSimilarity(user1: User, user2: User):Int{
    ...
    if (user1.stadt==user2.stadt) similarity += 1
    if (abs(user1.alter.toInt()-user2.alter.toInt())<=5 ) similarity += 1
    if (user1.erfahrung==user2.erfahrung) similarity += 1
    user1.genre.forEach {
...
val userList = listOf<User>(
    User(0,"", listOf(),0,0, listOf()),
    User(1,"Köln", listOf(Genre.Abstract,Genre.Strategy,Genre.Thematic,Genre.Wargame),23,1, listOf(2,17,29,31,37,44,47)),
    User(2,"Köln", listOf(Genre.Party,Genre.Strategy,Genre.Thematic),34,2, listOf(5,8,19,27,39,45)),
    User(3,"Köln", listOf(Genre.Family,Genre.Abstract),54,4, listOf(1,15,24,30)),
    User(4,"Köln", listOf(Genre.Abstract,Genre.Customizable,Genre.Party,Genre.Strategy,Genre.Thematic),34,4,  listOf(9,5,11,17,20,27,33,31,42,50)),
    User(5,"Köln", listOf(Genre.Thematic,Genre.Wargame),50,3,  listOf(7,11,27,39,42,48)),
    User(6,"Köln", listOf(Genre.Children,Genre.Family),24,1,  listOf(3,19,26,41)),
    User(7,"Hamburg", listOf(Genre.Family,Genre.Thematic),34,2,  listOf(49,26)),
    User(8,"Hamburg", listOf(Genre.Strategy,Genre.Wargame),43,4,  listOf(43,48,29,22)),
    User(9,"Hamburg", listOf(Genre.Customizable,Genre.Party),22,1,  listOf(31,45,23,19,14,10)),
    User(10,"Hamburg", listOf(Genre.Family,Genre.Strategy,Genre.Thematic),34,5,  listOf(15,8,18,35,49)),
    User(11,"Hamburg", listOf(Genre.Abstract,Genre.Children,Genre.Thematic),45,4,  listOf(50,39,26,21,5,3,4)),
    User(12,"Hamburg", listOf(Genre.Strategy,Genre.Wargame,Genre.Party),40,5,  listOf(11,2,18,20,29,38,47)),
    User(13,"Hamburg", listOf(Genre.Family,Genre.Strategy),37,1,  listOf(49,26,18)),
    User(14,"Hamburg", listOf(Genre.Children,Genre.Party),48,2,  listOf(3)),
    User(15,"Hamburg", listOf(Genre.Party,Genre.Customizable,Genre.Strategy),24,3,  listOf(19,26,30)),
    User(16,"München", listOf(Genre.Thematic,Genre.Customizable),29,2,  listOf(27,18,39)),
    User(17,"München", listOf(Genre.Abstract,Genre.Customizable,Genre.Strategy),20,5,  listOf(24,29,31,33,42,43,48)),
    User(18,"München", listOf(Genre.Thematic,Genre.Children),45,3,  listOf(7,18,27,42,49,11)),
    User(19,"München", listOf(Genre.Customizable,Genre.Strategy),61,3,  listOf(18,6,14,29)),
    User(20,"München", listOf(Genre.Abstract,Genre.Family),36,3,  listOf(50,9,10,28)),
    User(21,"München", listOf(Genre.Party,Genre.Strategy,Genre.Thematic),38,4,  listOf(20,14,8,5,1,45,27)),
    User(22,"Berlin", listOf(Genre.Strategy,Genre.Thematic),31,1,  listOf(22,27,18,13)),
    User(23,"Berlin", listOf(Genre.Party,Genre.Customizable),27,2,  listOf(14,5)),
    User(24,"Berlin", listOf(Genre.Strategy,Genre.Children),22,3,  listOf(8,29,37,48)),
    User(25,"Berlin", listOf(Genre.Party,Genre.Strategy),43,4,  listOf(35,22,14)),
    User(26,"Berlin", listOf(Genre.Customizable,Genre.Thematic),43,4,  listOf(18,6,8)),
    User(27,"Berlin", listOf(Genre.Customizable,Genre.Family),40,5,  listOf(1,14,29,44)),
    User(28,"Berlin", listOf(Genre.Wargame,Genre.Customizable,Genre.Family),23,5,  listOf(31,29,48,37,33,13)),
    User(29,"Berlin", listOf(Genre.Abstract,Genre.Party),19,5,  listOf(9,5,17,23,28,36)),
    User(30,"Berlin", listOf(Genre.Strategy,Genre.Wargame),23,3,  listOf(48,22,20,2)),
    User(31,"Berlin", listOf(Genre.Wargame,Genre.Children),36,3,  listOf(37,43)),
    User(32,"Berlin", listOf(Genre.Abstract,Genre.Customizable),38,1,  listOf(50)),
    User(33,"Frankfurt am Main", listOf(Genre.Thematic,Genre.Party),25,3,  listOf(27,11,8,29)),
    User(34,"Frankfurt am Main", listOf(Genre.Strategy,Genre.Thematic),21,4,  listOf(29,48,44,18,8)),
    User(35,"Frankfurt am Main", listOf(Genre.Family,Genre.Party),37,3,  listOf(1,4,15,23,19)),
    User(36,"Frankfurt am Main", listOf(Genre.Children,Genre.Family,Genre.Party,Genre.Thematic),46,3,  listOf(3,4,14,23,29,41,49)),
    User(37,"Frankfurt am Main", listOf(Genre.Strategy,Genre.Thematic),39,2,  listOf(39,44,18,8,2)),
    User(38,"Düsseldorf", listOf(Genre.Children,Genre.Thematic),25,2,  listOf(16)),
    User(39,"Düsseldorf", listOf(Genre.Abstract,Genre.Strategy,Genre.Thematic),24,4,  listOf(36,44,43,48,8,18,27)),
    User(40,"Düsseldorf", listOf(Genre.Strategy,Genre.Abstract),34,5,  listOf(11,27,29,37,48)),
    User(41,"Stuttgart", listOf(Genre.Strategy,Genre.Thematic),35,3,  listOf(48,50,44,29,6)),
    User(42,"Stuttgart", listOf(Genre.Children,Genre.Family,Genre.Party),38,2,  listOf(15,14,23,4,16)),
    User(43,"Stuttgart", listOf(Genre.Party,Genre.Wargame),53,2,  listOf(19,34,30)),
    User(44,"Bonn", listOf(Genre.Abstract,Genre.Children,Genre.Strategy),27,4,  listOf(50,1,4,28,24,17)),
    User(45,"Bonn", listOf(Genre.Family,Genre.Wargame),37,1,  listOf(49,26,21)),
    User(46,"Essen", listOf(Genre.Thematic,Genre.Children),26,5,  listOf(35,23,8,44,50)),
    User(47,"Essen", listOf(Genre.Customizable,Genre.Children),35,1,  listOf(29,31,25,1)),
    User(48,"Aachen", listOf(Genre.Abstract,Genre.Customizable,Genre.Party,Genre.Strategy),23,2,  listOf(8,9,10,14,50,43,48,22,18,13)),
    User(49,"Aachen", listOf(Genre.Strategy,Genre.Thematic),25,3,  listOf(8,18,7,27)),
    User(50,"Gummersbach", listOf(Genre.Customizable,Genre.Strategy,Genre.Thematic),30,3,  listOf(27,29,44,14,6)),
)
